...
APPLICATION='/weconnecttemplateproject'
...
DESKTOPIMAGENAME='geppettotest/weconnecttemplateproject-desktop:1.0'
...
helm install --name weconnecttemplateproject-1172 ./helm
if [ $? -eq 0 ]; then
